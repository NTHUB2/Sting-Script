...
local TeleportSection = page:addSection("Function")
...
local Server = i:addSection("Server")
local OpenUi = i:addSection("Gui")
...
Server:addButton("Low Server",function()
...
local CodeSection = i:addSection("Codes Section")
...
local Shop = venyx:addPage("Shop", 9006897360)
...
Special:addToggle("Auto Random Fruit", nil, function(value)
_G.Random = value
...
local AutoFarmBoss = MainPage:addSection("Boss")
...
local AutoStoryQuest = MainPage:addSection("Auto Quest")
if FirstSea then
...
local colors = theme:addSection("Setting Colors")
